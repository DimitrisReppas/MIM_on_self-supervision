...
from util.models_evaluation.head import iBOTHead
...
def train_ibot(args):
    ...
    if args.arch in models_evaluation.__dict__.keys() and 'swin' in args.arch:
        student = models_evaluation.__dict__[args.arch](
            window_size=args.window_size,
            return_all_tokens=True, 
            masked_im_modeling=args.use_masked_im_modeling,
        )
        teacher = models_evaluation.__dict__[args.arch](
            window_size=args.window_size,
            drop_path_rate=0.0,
            return_all_tokens=True,
        )
    ...
    elif args.arch in models_evaluation.__dict__.keys():
        student = models_evaluation.__dict__[args.arch](
